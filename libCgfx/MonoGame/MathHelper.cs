...
namespace Microsoft.Xna.Framework
{
    ...
    internal static class MathHelper
    {
        ...
        /// </summary>
        internal const float E = (float)Math.E;
        ...
        /// </summary>
        internal const float PiOver2 = (float)(Math.PI / 2.0);

        /// <summary>
        /// Represents the value of pi divided by four(0.7853982).
        /// </summary>
        internal const float PiOver4 = (float)(Math.PI / 4.0);
        ...
        internal static float Barycentric(float value1, float value2, float value3, float amount1, float amount2)
        {
        ...
        internal static float CatmullRom(float value1, float value2, float value3, float value4, float amount)
        {
        ...
        internal static float Distance(float value1, float value2)
        {
        ...
        internal static float Max(float value1, float value2)
        {
        ...
        internal static float Min(float value1, float value2)
        {
        ...
        /// <returns>Interpolated value.</returns>
        internal static float SmoothStep(float value1, float value2, float amount)
        {
